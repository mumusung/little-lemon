...
function Card({title}){
    ...
    return (
        <div className='card-display'>
            ...
            <img src={salad} alt="" height={150} width={250} onClick={handleClick} style={{cursor:"pointer"}}/>
            <h2>Greek Salad   <span style={{color:'orange'}}>$12.99</span></h2>
            <p>The famous greek salad of crispy lettuce, peppers, olives and our Chicago style feta cheese, garnished with crunchy garlic and rosemary croutons. </p>
        </div>
        <div className="card-container">
            <img src={bruchetta} alt=""height={150} width={250} onClick={handleClick} style={{cursor:"pointer"}}/>
        ...
        <div className="card-container">
            <img src={lemon} alt=""height={150} width={250} onClick={handleClick} style={{cursor:"pointer"}}/>
